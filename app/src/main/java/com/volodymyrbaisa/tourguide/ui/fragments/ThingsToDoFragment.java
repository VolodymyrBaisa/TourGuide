...
public class ThingsToDoFragment extends BaseFragment implements MainContract.View {
    @Inject
    protected MainContract.Presenter mPresenter;

    @BindView(R.id.things_to_do_items)
    ListView mListView;
    ...
    public android.view.View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        android.view.View root = inflater.inflate(R.layout.fragment_things_to_do, container, false);
    ...
    private void init() {
        ...
        ListAdapter listAdapter = new ListAdapter(getContext(), R.layout.item_view, mPresenter.getItemsThingsToDo());
