...
public class DiningFragment extends BaseFragment implements MainContract.View {
    @Inject
    protected MainContract.Presenter mPresenter;

    @BindView(R.id.dining_items)
    ListView mListView;
    ...
    public android.view.View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        android.view.View root = inflater.inflate(R.layout.fragment_dining, container, false);
    ...
    private void init() {
        ...
        ListAdapter listAdapter = new ListAdapter(getContext(), R.layout.item_view, mPresenter.getItemsDining());
