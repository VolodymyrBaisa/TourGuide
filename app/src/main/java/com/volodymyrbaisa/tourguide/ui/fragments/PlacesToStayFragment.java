...
public class PlacesToStayFragment extends BaseFragment implements MainContract.View {
    @Inject
    protected MainContract.Presenter mPresenter;

    @BindView(R.id.places_to_stay_items)
    ListView mListView;

    @Inject
    public PlacesToStayFragment() {
    }

    @Nullable
    @Override
    public android.view.View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        android.view.View root = inflater.inflate(R.layout.fragment_places_to_stay, container, false);
    ...
    private void init() {
        ...
        ListAdapter listAdapter = new ListAdapter(getContext(), R.layout.item_view, mPresenter.getItemsPlacesToStay());
